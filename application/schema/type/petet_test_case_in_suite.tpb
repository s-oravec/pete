CREATE OR REPLACE TYPE BODY petet_test_case_in_suite AS
    ...
    BEGIN
        ...
        END IF;
        --
        IF NOT (self.test_suite_id = p_obj_in.test_suite_id OR
            (self.test_suite_id IS NULL AND p_obj_in.test_suite_id IS NULL))
        THEN
            RETURN pete_core.g_NO;
        END IF;
        --
        ...
        THEN
            IF NOT ((self.test_case IS NULL AND p_obj_in.test_case IS NULL) OR
