...
prompt Creating package PETE_UTILS
@@pete_utils.pks
...
prompt Creating package PETE_CONFIGURATION_RUNNER_ADM
@@pete_configuration_runner_adm.pks

prompt Creating package PETE
@@pete.pks

prompt Creating package body PETE_UTILS
@@pete_utils.pkb
...
prompt Creating package body pete_configuration_runner_adm
@@pete_configuration_runner_adm.pkb
