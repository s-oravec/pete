create or replace package body pete_utils as
    ...
    --------------------------------------------------------------------------------
    function get_enquoted_schema_name(a_schema_name_in in varchar2) return varchar2 is
    begin
    ...
    --------------------------------------------------------------------------------
    function get_sql_schema_name(a_schema_name_in in varchar2) return varchar2 is
    begin
        return replace(get_enquoted_schema_name(a_schema_name_in => a_schema_name_in), '"');
    end;

    --------------------------------------------------------------------------------
    function get_enquoted_schema_name(a_package_name_in in varchar2) return varchar2 is
    begin
    ...
    --------------------------------------------------------------------------------
    function get_sql_schema_name(a_package_name_in in varchar2) return varchar2 is
    begin
        return replace(get_enquoted_schema_name(a_package_name_in => a_package_name_in), '"');
    end;

    --------------------------------------------------------------------------------
    function get_enquoted_package_name(a_package_name_in in varchar2) return varchar2 is
    begin
        if a_package_name_in is null then
            return null;
        elsif instr(a_package_name_in, '.') = 0 then
    ...
    --------------------------------------------------------------------------------
    function get_sql_package_name(a_package_name_in in varchar2) return varchar2 is
    begin
